...
const letterDiv = document.querySelector('.letter-div'),
    ...
    popup = document.querySelector('.notif'),
    popupContent = document.querySelector('.notif-content'),
    popupSpan = document.querySelector('.notif-span'),
...
const showNotif = msg => {
        ...
        popupSpan.textContent = select_word;
        popupContent.textContent = `You ${msg} `;
    },
    getindexes = letter => {
        let indexes = [];
        let i;
